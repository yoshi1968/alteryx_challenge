...
My solution.
I added a error message when the input parameters required more than 52 cards.

- Task 1 Workflow

![Workflow](../images/C488_task1_wf.png)

- Task 2-3 Workflow

![Workflow](../images/C488_task2-3_wf.png)

- App image

![App image](../images/C488_app.png)

-  Error message

![Error message](../images/C488_error_message.png)

- Output - Draw pile

![Draw pile](../images/C488_draw_pile.png)

- OUtput - Players hands

![Players hands](../images/C488_players_hands.png)

- Output - Cards ordered

![Cards ordered](../images/C488_cards_ordered.png)
